...
public final class TestNewsGroups {
  ...
  public void run(PrintWriter output) throws IOException {
    ...
    // test documents
    File baseDir = new File(inputFile);
    List<File> files = Lists.newArrayList();
    for (File newsgroup : baseDir.listFiles()) {
    ...
    ResultAnalyzer resultAnalyzer = new ResultAnalyzer(newsGroups.values(), "DEFAULT");
    for (File file : files) {
