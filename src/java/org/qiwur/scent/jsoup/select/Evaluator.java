...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<org.qiwur.scent.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (org.qiwur.scent.jsoup.nodes.Attribute attribute : values) {
     ...
     * Evaluator for matching Element's own text
     */
    public static final class ContainsStrippedOwnText extends Evaluator {
        private String searchText;

        public ContainsStrippedOwnText(String searchText) {
            this.searchText = searchText.toLowerCase();
        }
        ...
        @Override
        public String toString() {
            return String.format(":containsStrippedOwn(%s", searchText);
        }
    }
