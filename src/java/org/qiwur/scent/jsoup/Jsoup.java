...
import org.qiwur.scent.jsoup.safety.Cleaner;
import org.qiwur.scent.jsoup.safety.Whitelist;
...
public class Jsoup {
    ...
    public static Connection connect(String url, String proxyHost, int proxyPort) {
        return HttpConnection.connect(url, proxyHost, proxyPort);
    }
    ...
    /**
     ...
     @see #clean(String, org.qiwur.scent.jsoup.safety.Whitelist) 
     */
