...
public class Document extends Element {
  ...
  private DomSegments domSegments = new DomSegments();

  private IndicatorIndex indicatorIndex = new IndicatorIndex();
   ...
   * @see org.qiwur.scent.jsoup.Jsoup#parse
   * @see #createShell
   */
  ...
  public DomSegments domSegments() {
    return domSegments;
  }

  public IndicatorIndex indicatorIndex() {
    return indicatorIndex;
  }

  public TreeMultimap<Double, Element> indicatorIndex(String name) {
    return indicatorIndex.get(name);
  }

  public TreeMultimap<Double, Element> indicatorIndex(String name, TreeMultimap<Double, Element> index) {
    return indicatorIndex.put(name, index);
  }
   ...
   */
  public String title() {
    // title is a preserve whitespace tag (for document output), but normalised
    // here
  ...
  private void normaliseStructure(String tag, Element htmlEl) {
    ...
    Element master = elements.first(); // will always be available as created
  ...
  public static class OutputSettings implements Cloneable {
     ...
     * charset is automatically set to the input charset. Otherwise, it defaults
     * to UTF-8.
     * 
     ...
     * output methods will not re-format the output, and the output will
