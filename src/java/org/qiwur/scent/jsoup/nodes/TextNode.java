...
public class TextNode extends Node {
     ...
     */
    public String text() {
        return normaliseWhitespace(Entities.unescape(getWholeText()));
    }
    ...
    static String stripLeadingWhitespace(String text) {
    	...
    	text = text.replaceFirst(StringUtil.NBSP, "");
        return text.replaceFirst("^\\s+", "");
    }

    static boolean lastCharIsWhitespace(StringBuilder sb) {
        return sb.length() != 0 && StringUtil.isWhitespace(sb.charAt(sb.length() - 1));
    }
