 ...
 * is not a complete solution to the problem (sub-classes of restrictions, for
 * example, are not shown). It is intended only to be illustrative of the
 * general approach.
 * </p>
 */
public class ClassHierarchy {
  ...
  /**
   * Present a class, then recurse down to the sub-classes. Use occurs check to
