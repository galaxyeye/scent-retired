...
/**
 * <p>
 * Simple example of describing the basic attributes of a OWL, DAML or RDFS
 * class using the ontology API. This is not meant as a definitive solution to
 * the problem, but as an illustration of one approach to solving the problem.
 * This example should be adapted as necessary to provide a given application
 * with the means to render a class description in a readable form.
 * </p>
 */
